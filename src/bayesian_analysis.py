...
def main():
    ...
    # 標準化
    continuous_cols = ['political_ratio', 'budget_log']
    ...
    # 共通の右辺（説明変数）
    base_formula_rhs = """
        political_ratio_std * over_100news + budget_log_std + belongs_to_collection + 
    ...
    interaction_term = 'political_ratio_std:over_100news'
